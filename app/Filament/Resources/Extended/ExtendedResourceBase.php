...
abstract class ExtendedResourceBase
{
    use Macroable {
    ...
    protected static bool $onlyTenantScope = false;
    protected static bool $onlyGlobalScope = false;
    ...
    {
        // $onlyTenantScope = static::tenantScopeIsRequired(); // Talvez usar aqui???
    ...
    public static function tenantScopeChecker(): void
    {
        abort_if(static::globalScopeIsRequired() && (tenancy()->initialized), 404);
        abort_if(static::tenantScopeIsRequired() && ! (tenancy()->initialized), 404);
    }

    public static function getEloquentQuery(): Builder
    {
        static::tenantScopeChecker();
    ...
    {
        if (static::globalScopeIsRequired()) {
            return !(tenancy()->initialized);
        }

        if (static::tenantScopeIsRequired()) {
            return tenancy()->initialized;
        }
    ...
    public static function tenantScopeIsRequired(): bool
    {
        return method_exists(static::getModel(), 'onlyTenantScope')
            ? call_user_func([static::getModel(), 'onlyTenantScope']) :
            static::$onlyTenantScope;
    }

    public static function globalScopeIsRequired(): bool
    {
        return method_exists(static::getModel(), 'onlyGlobalScope')
            ? call_user_func([static::getModel(), 'onlyGlobalScope']) :
            static::$onlyGlobalScope;
    }
